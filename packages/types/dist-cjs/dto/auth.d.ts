...
export declare class RegisterDto implements AuthRegisterRequest {
    email: string;
    name: string;
    password: string;
}
export declare class LoginDto implements AuthLoginRequest {
    email: string;
    password: string;
}
export declare class RefreshDto implements AuthRefreshRequest {
    refreshToken: string;
}
